...
public class Plane implements MoveableShape
{
   ...
   */
   ...
   public void draw(Graphics2D g2)
   {
      ...
      QuadCurve2D.Double headCurve2 = new QuadCurve2D.Double(x + width, y + width / 3 - 1, x + width + width / 3, y + width / 3, x + width + width / 3, y + width / 3 - 5);
      
      QuadCurve2D.Double headCurve = new QuadCurve2D.Double(x + width, y + width / 6, x + width + width / 3, y + width / 6,  x + width + width / 3, y + width / 3 - 5);
      
      Line2D.Double tailLine2 = new Line2D.Double(x - 20, y - 10, x - 15, y - 10);
      
      QuadCurve2D.Double tailCurve = new QuadCurve2D.Double(x, y + width / 3 - 1, x - 18, y + width / 3 - 2, x - 20, y - 10);
